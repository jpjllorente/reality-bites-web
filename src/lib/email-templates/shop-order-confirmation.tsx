...
const Email = ({
  ...
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Confirmación de tu pedido en 144 Reality</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          ...
          <Text style={lead}>
            Hemos recibido tu pago correctamente. Aquí tienes el detalle de tu
        ...
        <Section style={infoBox}>
          ...
          <Text style={paragraph}>
            Estamos preparando tu pedido. Pasa a recogerlo por nuestro local en
          ...
          {whatsappHref ? (
            <Text style={paragraph}>
              Si quieres coordinar una hora concreta o darnos algún detalle
              extra, escríbenos por WhatsApp:{" "}
...
export const template = {
  ...
  subject: (d: Record<string, any>) =>
    `Tu pedido en 144 Reality${d?.orderId ? ` #${String(d.orderId).slice(0, 8)}` : ""}`,
  displayName: "Confirmación pedido tienda",
  previewData: {
    name: "María",
...
const infoBox = { padding: "8px 0 16px" };
